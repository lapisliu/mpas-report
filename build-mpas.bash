...
function main()
{
 ...
 # export CORE=atmosphere
  ...
  export INTEL_WRAPPER_PATH="/home/apps/utils/intel"
  ...
  export OPTIMIZATION_FLAGS_FOR_INTEL_COMPILERS="-fPIC -unroll -ip -xCORE-AVX512 -qopenmp -qopt-report-stdout -qopt-report-phase=openmp -diag-disable=10441"
  ...
  export OPTIMIZATION_FLAGS="-Ofast" 
